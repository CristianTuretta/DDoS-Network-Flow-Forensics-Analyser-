...
if __name__ == '__main__':
	...
	if args.generate:
		...
		perfAnalyser.performance_eval(analysis_routine, args.analyze[0], args.analyze[1])
		...
		perfAnalyser.performance_eval(analysis_routine, args.genanalyze[0], args.genanalyze[3])
	else:
		parser.print_help()
