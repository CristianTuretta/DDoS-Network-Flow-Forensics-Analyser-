...
\begin{itemize}
	\item{\textit{DDoSAnalysis.py}}: this script can be used in two different modes, depending on the line parameters used. 
		...
		\pagebreak
		\item{\textit{PerformanceAnalyser.py}}: this script is used to automatically plot all the infos stored under  \path{PerformanceHistory.csv}. It supports two modes:
			\begin{itemize}
